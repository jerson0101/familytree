...
"[project]/apps/web/src/app/(dashboard)/tree/genogram/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GenogramPage() {
    ...
    const { persons, unions, isLoading, getRootPerson, getParentsOfPerson, getPersonRole } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$hooks$2f$useFamilyTree$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFamilyTree"])();
    const rootPerson = getRootPerson();
    // Transform persons into genogram format with generations
    const genogramPersons = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GenogramPage.useMemo[genogramPersons]": ()=>{
            if (!rootPerson || persons.length === 0) return [];
            const result = [];
            const visited = new Set();
            // Helper to add person with generation
            const addPerson = {
                "GenogramPage.useMemo[genogramPersons].addPerson": (person, generation)=>{
                    if (visited.has(person.id)) return;
                    visited.add(person.id);
                    const conditions = (person.medicalConditions || []).map({
                        "GenogramPage.useMemo[genogramPersons].addPerson.conditions": (c)=>c.name
                    }["GenogramPage.useMemo[genogramPersons].addPerson.conditions"]);
                    result.push({
                        id: person.id,
            ...
            }["GenogramPage.useMemo[genogramPersons].addPerson"];
            ...
            if (rootParents.fatherId) {
                const father = persons.find({
                    "GenogramPage.useMemo[genogramPersons].father": (p)=>p.id === rootParents.fatherId
                }["GenogramPage.useMemo[genogramPersons].father"]);
                if (father) addPerson(father, 1);
            }
            if (rootParents.motherId) {
                const mother = persons.find({
                    "GenogramPage.useMemo[genogramPersons].mother": (p)=>p.id === rootParents.motherId
                }["GenogramPage.useMemo[genogramPersons].mother"]);
            ...
            if (rootParents.fatherId) {
                ...
                if (fatherParents.fatherId) {
                    const gf = persons.find({
                        "GenogramPage.useMemo[genogramPersons].gf": (p)=>p.id === fatherParents.fatherId
                    }["GenogramPage.useMemo[genogramPersons].gf"]);
                    if (gf) addPerson(gf, 0);
                }
                if (fatherParents.motherId) {
                    const gm = persons.find({
                        "GenogramPage.useMemo[genogramPersons].gm": (p)=>p.id === fatherParents.motherId
                    }["GenogramPage.useMemo[genogramPersons].gm"]);
            ...
            if (rootParents.motherId) {
                ...
                if (motherParents.fatherId) {
                    const gf = persons.find({
                        "GenogramPage.useMemo[genogramPersons].gf": (p)=>p.id === motherParents.fatherId
                    }["GenogramPage.useMemo[genogramPersons].gf"]);
                    if (gf) addPerson(gf, 0);
                }
                if (motherParents.motherId) {
                    const gm = persons.find({
                        "GenogramPage.useMemo[genogramPersons].gm": (p)=>p.id === motherParents.motherId
                    }["GenogramPage.useMemo[genogramPersons].gm"]);
                    if (gm) addPerson(gm, 0);
                }
            }
            ...
            if (rootParents.unionId) {
                const parentUnion = unions.find({
                    "GenogramPage.useMemo[genogramPersons].parentUnion": (u)=>u.id === rootParents.unionId
                }["GenogramPage.useMemo[genogramPersons].parentUnion"]);
                if (parentUnion) {
                    for (const childId of parentUnion.children){
                        const sibling = persons.find({
                            "GenogramPage.useMemo[genogramPersons].sibling": (p)=>p.id === childId
                        }["GenogramPage.useMemo[genogramPersons].sibling"]);
                ...
                if (union.partner1Id === rootPerson.id || union.partner2Id === rootPerson.id) {
                    for (const childId of union.children){
                        const child = persons.find({
                            "GenogramPage.useMemo[genogramPersons].child": (p)=>p.id === childId
                        }["GenogramPage.useMemo[genogramPersons].child"]);
    ...
    const conditionRisks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GenogramPage.useMemo[conditionRisks]": ()=>{
            ...
            return Object.entries(conditionCount).sort({
                "GenogramPage.useMemo[conditionRisks]": ([, a], [, b])=>b - a
            }["GenogramPage.useMemo[conditionRisks]"]).map({
                "GenogramPage.useMemo[conditionRisks]": ([condition, count])=>({
                        condition,
                        occurrences: count,
        ...
        children: [
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: gen.map((person)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            person.isDeceased && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        selectedPerson.conditions.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2f$src$2f$primitives$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2f$src$2f$primitives$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: conditionRisks.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-4",
                            children: conditionRisks.map((risk)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(GenogramPage, "0p38whlkQGKl9LUKpPrvrxsu+bc=", false, function() {
    return [
...
_c3 = HeartIcon;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "GenogramPage");
...
//# sourceMappingURL=apps_web_src_ab338a15._.js.map