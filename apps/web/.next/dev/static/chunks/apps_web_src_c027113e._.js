...
function SecurityPage() {
    ...
    const familyMembersWithLocation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SecurityPage.useMemo[familyMembersWithLocation]": ()=>{
            ...
            const members = persons.map({
                "SecurityPage.useMemo[familyMembersWithLocation].members": (person)=>{
                    // Find real location data for this person
                    const locationData = familyLocations.find({
                        "SecurityPage.useMemo[familyMembersWithLocation].members.locationData": (loc)=>{
                    ...
                    }["SecurityPage.useMemo[familyMembersWithLocation].members.locationData"]);
                    if (locationData) {
            ...
            }["SecurityPage.useMemo[familyMembersWithLocation].members"]);
            // Add locations from users who are sharing but not yet linked to a person in the tree
            familyLocations.forEach({
                "SecurityPage.useMemo[familyMembersWithLocation]": (loc)=>{
...
//# sourceMappingURL=apps_web_src_c027113e._.js.map