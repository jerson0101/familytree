module.exports = [
"[project]/apps/web/src/app/(dashboard)/security/zones/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HeritageZonesPage() {
    ...
    const [newZone, setNewZone] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        name: '',
        address: '',
        radius: 100,
        type: 'home'
    ...
    const fetchZones = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!currentFamily?.id) {
            setZones([]);
            setIsLoading(false);
            return;
...
//# sourceMappingURL=apps_web_src_app_%28dashboard%29_security_zones_page_tsx_040aeb7b._.js.map